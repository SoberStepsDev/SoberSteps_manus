...
const _lessons = [
  ...
  _Lesson('Finanse po uzależnieniu', 'Finances After Addiction', '💰', 2,
      'Uzależnienie to nie tylko problem zdrowotny — to poważny cios w finanse. Wiele osób wydaje rocznie bardzo duże kwoty na alkohol lub substancje (rząd tysięcy — dokładnie zależy od kraju i nawyku). Narkotyki bywają jeszcze droższe.\n\nPo odstawieniu:\n\n1. Natychmiast: Przestań wydawać na substancję. Śledź szacunek oszczędności w zakładce Oszczędności w SoberSteps.\n\n2. Miesiąc 1: Oceń szkody — długi, nieopłacone rachunki, stracone możliwości.\n\n3. Miesiąc 2-6: Budżet. Każda zaoszczędzona kwota idzie na: spłatę długów (50%), fundusz awaryjny (30%), nagrody za trzeźwość (20%).\n\n4. Rok 1+: Inwestuj w siebie: kurs, terapia, hobby, podróże — to nagrody, które nie kradną jutrzejszego dnia.',
      "Addiction is not just a health problem \u2014 it's a heavy financial burden. Many people spend many thousands per year on alcohol or substances; exact amounts vary widely by region and pattern of use. Drugs often cost much more.\n\nAfter quitting:\n1. Immediately: Stop spending on the substance. Track your estimated savings in the Savings tab in SoberSteps.\n2. Month 1: Assess the damage \u2014 debts, unpaid bills, lost opportunities.\n3. Months 2-6: Budget. Every amount you save goes to: debt repayment (50%), emergency fund (30%), sobriety rewards (20%).\n4. Year 1+: Invest in yourself: course, therapy, hobby, travel \u2014 rewards that don't steal tomorrow.",
