          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text('Naomi jest dostępna w Recovery+',
                    style: TextStyle(color: AppColors.textPrimary, fontSize: 18, fontWeight: FontWeight.w700),
                    textAlign: TextAlign.center),
                const SizedBox(height: 8),
                const Text('Twój AI towarzysz — pyta, nie ocenia.',
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    child: const Text('Odkryj Recovery+', style: TextStyle(color: Colors.white, fontSize: 16)),
                  ),
                ),
              ],
            ),
